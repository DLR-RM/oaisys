...
class SensorCameraRGBD(TSSSensor):
    ...
    def log_step(self, keyframe):
        _trans = self._sensor.matrix_world.to_translation()
        _quat = self._sensor.matrix_world.to_quaternion()
        pose = [str(_trans[0]), str(_trans[1]), str(_trans[2]),
                str(_quat[0]), str(_quat[1]),
                str(_quat[2]), str(_quat[3])]
        self._logger.log_pose(f"{self._sensor.name}", pose)
    ...
    def _create_single_camera(self):
        ...
        _tf_quat = self._cfg["transformation"]
        _tf_quat_blender = cp.deepcopy(_tf_quat)

        #_tf_quat_blender[3] = -_tf_quat[4]
        #_tf_quat_blender[4] = _tf_quat[3]
        #_tf_quat_blender[5] = _tf_quat[6]
        #_tf_quat_blender[6] = -_tf_quat[5]

        _tf_quat_blender[3] = _tf_quat[3]
        _tf_quat_blender[4] = _tf_quat[4]
        _tf_quat_blender[5] = _tf_quat[5]
        _tf_quat_blender[6] = _tf_quat[6]

        self._base_to_sensor = _tf_quat_blender #self._cfg["transformation"]#_tf_quat_blender
